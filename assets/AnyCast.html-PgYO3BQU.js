...
<span class="line">}</span>
<span class="line"></span></code></pre></div><p>你可以直接按着我的配置文件修改(建议先去看看soha的教程 然后自己手写<sup class="footnote-ref"><a href="#footnote2">[2]</a><a class="footnote-anchor" id="footnote-ref2"></a></sup>), 改好后写入 <code>/etc/bird/bird.conf</code>, 然后应用配置文件 <code>bridc c</code></p><p>你可以运行 <code>birdc show protocols all</code> 查看当前所有协议的状态:</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">vultr    BGP        ---        up     <span class="token number">2025</span>-02-10    Established   </span>
...
<span class="line"></span></code></pre></div><p>宣告的IP段在全球范围内的转播和收敛需要一点时间, 你可与去干点别的事情, 或者干脆直接睡一觉(如果你是在半夜配置的话)。</p><p>等待半小时到一小时后, 可用打开 <a href="https://bgp.tools/" target="_blank" rel="noopener noreferrer">BGP Tools</a> 输入你的IP段查看全球范围内的转播情况。</p><figure><img src="https://s3.pysio.online/cdn-cgi/image/f=avif,onerror=redirect,slow-connection-quality=50/https://s3.pysio.online/pysioimages/20250217083854.png" alt="我的Anycast传播情况" tabindex="0" loading="lazy"><figcaption>我的Anycast传播情况</figcaption></figure><h2 id="_3-配置网卡" tabindex="-1"><a class="header-anchor" href="#_3-配置网卡"><span>3. 配置网卡</span></a></h2><p>目前我们已经成功地把 <code>2a14:67c1:a020::/48</code> 宣告出去了.</p><p>此时全球访问 <code>2a14:67c1:a020::/48</code> 的流量就已经被路由到我们这台 vps 上了, 不过我们的 vps 现在被配置为什么都不做, 直接返回 unreachable. 我们现在只需要在 vps 上做一些小小的配置就能为全球提供服务了:</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 创建一个 dummy 网卡</span></span>
...
<span class="line"></span></code></pre></div><p>完成后, 我们就可以从自己的电脑上 ping 到 <code>2a14:67c1:a020::1</code> 这个地址了.</p><h2 id="_4-anycast" tabindex="-1"><a class="header-anchor" href="#_4-anycast"><span>4. Anycast?</span></a></h2><p>现在 你可与参照上面的步骤在多台服务器上配置BGP Session, 然后在每台服务器上配置网卡, 配置相同的IP地址, 就可以实现Anycast了。(对就这么简单)</p><p>这样 你的访问会直接去找最近的服务器提供服务, 但是对于中国大陆来说 很可能绕地球一圈就是了。。。</p><p>当然如果你有钱, 可以找运营商(或者阿里/腾讯)BOYIP接入</p><h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章"><span>参考文章</span></a></h2><p><a href="https://blog.lyc8503.net/post/asn-2-bgp-session/" target="_blank" rel="noopener noreferrer">自己在家开运营商 Part.2 - 向世界宣告 IP 段 (BGP Session &amp; BIRD)</a></p><p><a href="https://blog.lyc8503.net/post/asn-4-anycast-network/" target="_blank" rel="noopener noreferrer">自己在家开运营商 Part.4 - 建立自己的 Anycast 网络</a></p><hr class="footnotes-sep"><section class="footnotes"><ol class="footnotes-list"><li id="footnote1" class="footnote-item"><p><a href="https://www.cloudflare.com/zh-cn/learning/cdn/glossary/anycast-network/" target="_blank" rel="noopener noreferrer">Anycast 网络是什么？| Anycast 的工作原理 | Cloudflare</a> <a href="#footnote-ref1" class="footnote-backref">↩︎</a></p></li><li id="footnote2" class="footnote-item"><p><a href="https://soha.moe/post/bird-bgp-kickstart.html" target="_blank" rel="noopener noreferrer">BIRD 与 BGP 的新手开场</a> <a href="#footnote-ref2" class="footnote-backref">↩︎</a></p></li></ol></section>`,47)])])}const c=s(p,[["render",o]]),r=JSON.parse(`{"path":"/posts/daily/AnyCast.html","title":"记一次AnyCast+博客搭建","lang":"zh-CN","frontmatter":{"title":"记一次AnyCast+博客搭建","date":"2025-02-15T00:00:00.000Z","icon":"fa-solid fa-router","category":"daily","tag":["BGP","日常"],"description":"因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。 Anycast 是什么? Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\"节点\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"记一次AnyCast+博客搭建\\",\\"image\\":[\\"https://s3.pysio.online/cdn-cgi/image/f=avif,onerror=redirect,slow-connection-quality=50/https://s3.pysio.online/pysioimages/20250216154622.png\\",\\"https://s3.pysio.online/cdn-cgi/image/f=avif,onerror=redirect,slow-connection-quality=50/https://s3.pysio.online/pysioimages/20250217081432.png\\",\\"https://s3.pysio.online/cdn-cgi/image/f=avif,onerror=redirect,slow-connection-quality=50/https://s3.pysio.online/pysioimages/20250217083854.png\\"],\\"datePublished\\":\\"2025-02-15T00:00:00.000Z\\",\\"dateModified\\":\\"2025-04-26T00:39:08.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Pysio\\",\\"url\\":\\"https://github.com/pysio2007/\\"}]}"],["meta",{"property":"og:url","content":"https://www.pysio.online/posts/daily/AnyCast.html"}],["meta",{"property":"og:site_name","content":"Pysio's Home"}],["meta",{"property":"og:title","content":"记一次AnyCast+博客搭建"}],["meta",{"property":"og:description","content":"因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。 Anycast 是什么? Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\"节点\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://s3.pysio.online/cdn-cgi/image/f=avif,onerror=redirect,slow-connection-quality=50/https://s3.pysio.online/pysioimages/20250216154622.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:locale:alternate","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2025-04-26T00:39:08.000Z"}],["meta",{"property":"article:tag","content":"日常"}],["meta",{"property":"article:tag","content":"BGP"}],["meta",{"property":"article:published_time","content":"2025-02-15T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2025-04-26T00:39:08.000Z"}],["link",{"rel":"alternate","hreflang":"en-us","href":"https://www.pysio.online/en/posts/daily/AnyCast.html"}],["meta",{"property":"article:published_time","content":"2025-02-15T00:00:00.000Z"}],["meta",{"name":"article:published_time","content":"2025-02-15T00:00:00.000Z"}],["meta",{"property":"article:tag","content":"BGP"}],["meta",{"property":"article:tag","content":"日常"}],["meta",{"property":"article:section","content":"daily"}],["meta",{"property":"og:title","content":"记一次AnyCast+博客搭建"}],["meta",{"property":"og:url","content":"https://www.pysio.online/posts/daily/AnyCast.html"}],["meta",{"property":"og:description","content":"因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。 Anycast 是什么? Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\"节点\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择..."}],["meta",{"name":"description","content":"因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。 Anycast 是什么? Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\"节点\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择..."}],["meta",{"name":"twitter:title","content":"记一次AnyCast+博客搭建"}],["meta",{"name":"twitter:description","content":"因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。 Anycast 是什么? Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\"节点\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择..."}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"BlogPosting\\",\\"headline\\":\\"记一次AnyCast+博客搭建\\",\\"author\\":{\\"@type\\":\\"Person\\",\\"name\\":\\"Pysio\\",\\"url\\":\\"https://github.com/pysio2007\\"},\\"publisher\\":{\\"@type\\":\\"Organization\\",\\"name\\":\\"Pysio's Home\\",\\"url\\":\\"https://www.pysio.online\\"},\\"url\\":\\"https://www.pysio.online/posts/daily/AnyCast.html\\",\\"datePublished\\":\\"2025-02-15T00:00:00.000Z\\",\\"dateModified\\":\\"2025-02-15T00:00:00.000Z\\",\\"description\\":\\"因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。 Anycast 是什么? Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\\\\\"节点\\\\\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择...\\",\\"mainEntityOfPage\\":{\\"@type\\":\\"WebPage\\",\\"@id\\":\\"https://www.pysio.online/posts/daily/AnyCast.html\\"}}"],["link",{"rel":"canonical","href":"https://www.pysio.online/posts/daily/AnyCast.html"}],["link",{"rel":"alternate","type":"application/rss+xml","title":"Pysio's Home RSS Feed","href":"https://www.pysio.online/rss.xml"}],["meta",{"property":"og:title","content":"记一次AnyCast+博客搭建"}],["meta",{"property":"og:description","content":"因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。 Anycast 是什么? Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\"节点\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择..."}],["meta",{"property":"og:image","content":"https://www.pysio.online/og-images/记一次anycast博客搭建.png"}],["meta",{"property":"og:url","content":"https://www.pysio.online/posts/daily/AnyCast.html"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:site_name","content":"Pysio's Home"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:title","content":"记一次AnyCast+博客搭建"}],["meta",{"name":"twitter:description","content":"因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。 Anycast 是什么? Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\"节点\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择..."}],["meta",{"name":"twitter:image","content":"https://www.pysio.online/og-images/记一次anycast博客搭建.png"}],["link",{"rel":"alternate","type":"application/rss+xml","href":"https://www.pysio.online/rss.xml","title":"Pysio's Home RSS Feed"}]]},"git":{"createdTime":1739692125000,"updatedTime":1745627948000,"contributors":[{"name":"Pysio","username":"Pysio","email":"qq593277393@outlook.com","commits":8,"url":"https://github.com/Pysio"}]},"readingTime":{"minutes":6.17,"words":1850},"filePathRelative":"posts/daily/AnyCast.md","excerpt":"<p>因为闲着没事干, 就打算搭建一个Anycast 然后把博客和DNS都放上去, 本文暂且记录一下Anycast+博客的搭建过程。</p>\\n<h2>Anycast 是什么?</h2>\\n<blockquote>\\n<p>Anycast 是一种网络寻址和路由方法, 可以将传入请求路由到各种不同的位置或\\"节点\\"。在 CDN 的上下文中, Anycast 通常会将传入的流量路由到距离最近并且能够有效处理请求的数据中心。选择性路由使 Anycast 网络能够应对高流量、网络拥塞和 DDoS 攻击。<sup class=\\"footnote-ref\\"><a href=\\"#footnote1\\">[1]</a><a class=\\"footnote-anchor\\" id=\\"footnote-ref1\\"></a></sup></p>\\n</blockquote>","autoDesc":true}`);export{c as comp,r as data};
